      ...
      .on("click", "[data-lightbox]", function (t) {
        ...
        var s = $(
          '<div id="lightbox-modal" class="modal fade"><div class="modal-dialog"><div class="modal-content ' +
            l +
            ' blocs-lb-container"><button id="blocs-lightbox-close-btn" type="button" class="close-lightbox" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><div class="modal-body"><a href="#" class="prev-lightbox" aria-label="prev"><img class="arrow-left" src="./img/arrow-left.svg" alt="Flèche vers la gauche" /></a><a href="#" class="next-lightbox" aria-label="next"><img class="arrow-right" src="./img/arrow-right.svg" alt="Flèche vers la droite" /></a><img id="lightbox-image" class="img-responsive" src="' +
            e +
